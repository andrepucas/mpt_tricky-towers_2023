...
//     [SerializeField] private ControllerCPU _cpu;
...
//                 if (_inVersusMode) OnDisplayCPU?.Invoke(true);
...
//                 //if (_inVersusMode) _cpu.Toggle(false);
//                 StopGame();
//                 break;
...
//     private void GetNewBlock(int p_layer)
//     {
...
//         // Ignore if it's not a player block.
//         if (p_block.gameObject.layer != _blocksData.LayerPlayer) return;
...
//         else if (p_block == _currentBlock) GetNewBlock(_blocksData.LayerPlayer);
...
//         {
//             //_cpu.Toggle(true);
//             _cpu.GetNewBlock(_blocksData.LayerCPU);
//         }
